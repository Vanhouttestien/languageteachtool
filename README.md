...
For colors there was chosen for a grey theme. This keeps the design elegant and simple. By applying dark and light contrasting colors the site is also accessible for users with view impairements. 
# Technologies used
...
- [Infinite Scroll](https://www.npmjs.com/package/react-infinite-scroll-component): To add a infinite scroll to postspage
...
# Features
1. navbar 
As I user I can sign up to get access to features for logged in users
As I user I can log in to get access to features for logged in users
As a user I can keep being  logged in until I log out. 

Navbar logged in: 
<img src="" alt="Entity Relationship Diagram" width="300px">

Navbar logged out: 
<img src="https://res.cloudinary.com/ds6jpxpzy/image/upload/v1670857160/navbarsignin_wmeddz.jpg" alt="screenshot navbar when signed out" width="300px">
...
8. Postlist 
As a user I can filter the post so I see only the posts that are relevant
As a user I see the posts list ordered on creation date, so I can see which are newest
As a user I can use keywords to search trough the posts so that I can quickly find relevant posts
